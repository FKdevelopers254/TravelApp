            ...
            builder: (context, snapshot) {
              ...
              return ListView(
                ...
                children: snapshot.data!.docs.map((document) {
                  ...
                  String likeCountString = document.get('likeCount');
                  int likeCount = int.parse(likeCountString);

                  bool isLiked = document.get('isLiked') ?? false;



                  final CollectionReference hotelsCollection = FirebaseFirestore.instance.collection('hotels');

                  Future<void> updateLikeCount(String hotelId, int likeCount) async {
                    await hotelsCollection.doc(hotelId).update({'likeCount': likeCount});
                  }
                  ...
                  return GestureDetector(
                    onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context) => HotelScreen(hotel: document.id),),);},
                                ...
                                children: [
                                  IconButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      await updateLikeCount(hotelId, likeCount);
