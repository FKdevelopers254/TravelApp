...
class SafariScreen extends StatelessWidget {
  final Map<String, String>  safari;
            ...
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                ...
                title:  AnimatedTextKit(
                  animatedTexts: [
                    TypewriterAnimatedText(safari['name']!,textStyle: GoogleFonts.bebasNeue(color: Colors.white)),
                    TypewriterAnimatedText(safari['hotelname']!,textStyle: GoogleFonts.bebasNeue(color: Colors.white)),
                    TypewriterAnimatedText(safari['location']!,textStyle: GoogleFonts.bebasNeue(color: Colors.white)),
                    TypewriterAnimatedText(safari['price']!,textStyle: GoogleFonts.bebasNeue(color: Colors.white)),
                  ...
                  children: <Widget>[
                    ...
                    Positioned(
                        ...
                        child: ElevatedButton(
                            ...
                            child: Row(
                              children: [
                                Text('\$${safari['price']!}',style: const TextStyle(fontSize: 20),),
