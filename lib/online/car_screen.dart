...
class CarScreen extends StatelessWidget {
  ...
  void _uploadData() async {
    ...
    final response = await http.post(url,
        body: {'title': car['name']!, 'description': _description});
            ...
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                ...
                title:  AnimatedTextKit(
                  animatedTexts: [
                    TypewriterAnimatedText(car['name']!,textStyle: GoogleFonts.bebasNeue(color: Colors.white)),
                    TypewriterAnimatedText(car['price']!,textStyle: GoogleFonts.bebasNeue(color: Colors.white)),
